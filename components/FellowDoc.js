            ...
            <div className="flex mb-10 ">
                <div className="min-w-[400px] text-[#A0A0A0]">
                    ...
                    <div className="w-[380px] h-auto  mt-2 mb-5">
                        ...
                        <a href={`${summaryDocs.map((summaryDoc) => ((summaryDoc.file)))}`} >
                    ...
                    <div className="w-[380px] h-auto  mt-2 mb-5">
                        ...
                        <a href={`${proposalDocs.map((proposalDoc) => ((proposalDoc.file)))}`} >
                        <button className="bg-[#91466b] text-white w-[100px] h-[35px] rounded-[20px] mt-2">อ่าน</button>
                        </a>
                    </div>
                ...
                <div className="w-[400px] text-[#A0A0A0]">
                    ...
                    <div className="w-[380px] h-auto  mt-2 mb-5">
                        ...
                        <a href={`${progressDocs.map((progressDoc) => ((progressDoc.file)))}`} >
                        <button className="bg-[#91466b] text-white w-[100px] h-[35px] rounded-[20px] mt-2">อ่าน</button>
                        </a>
                    </div>
                    <div className="w-[380px] h-auto  mt-2 mb-5">
                        ...
                        <a href={`${reflectionDocs.map((reflectionDoc) => ((reflectionDoc.file)))}`} >
                        <button className="bg-[#91466b] text-white w-[100px] h-[35px] rounded-[20px] mt-2">อ่าน</button>
                        </a>
                    </div>
                </div>
