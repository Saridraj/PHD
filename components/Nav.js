        ...
        <div>
            <nav className="text-[#91466b] bg-white flex justify-between items-center w-full h-[54px] p-2  pl-10 md:pl-20  pr-10 md:pr-20 drop-shadow-md">
                ...
                {click ?(
                    ...
                    <ul className="md:flex md:items-center z-[-1] md:z-auto md:static absolute w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-7 mt-[200px] md:mt-0 bg-white md:opacity-100  opacity-0 transition-[2s] ease-in-out duration-500" >
                    <li className=" m-2 flex  items-center">
