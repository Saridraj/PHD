    ...
    return (
        <div>
            <nav className="text-[#91466b] bg-white flex justify-between items-center w-full h-[54px] p-2 pl-20 pr-20 drop-shadow-md">
                ...
                <div className="flex ">
                    <Link href="/profile">
                    <div className="flex min-w-[200px] bg-purple-100 rounded-[50px] mr-20 h-[45px] p-1 items-center">
                    ...
                    <div className="flex justify-between items-center">
                        {user ? (
                            <div >
                                <botton  onClick={logoutHandler} ><p>Logout</p></botton>
                            </div>
                        ) : (<></>)}
                    </div>
